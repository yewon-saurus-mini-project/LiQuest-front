      ...
      >
        <form>
              ...
              <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <div className="sm:col-span-2">
                  <Input
                    label="이름"
                    value={
                      FirstnameInitial && userData !== null
          ...
          <div className="mt-3 flex items-center justify-end gap-x-2">
            <Button mode="cancle" onClick={() => nav("/myinfo")}>
              취소
            </Button>
            <Button mode="primary" onClick={() => setIsPopupOpen(true)}>
              수정
            </Button>

            {isPopupOpen && (
              <ConfirmPopup
                onCancle={() => setIsPopupOpen(false)}

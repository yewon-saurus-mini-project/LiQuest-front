...
function NoticeDetail({ initialNoticeData = {} }) {
  ...
  useEffect(() => {
    axios
      .get(import.meta.env.VITE_API_URL + `/notice/${noticeId}/`, {
        headers: {
  ...
  return (
    <div data-color-mode="light" className="lg:px-40 lg:py-10 p-4 m-auto">
      ...
      <div className="flex justify-end">
        <Button onClick={() => nav("/notice")}>공지 목록</Button>
      </div>
    </div>
  );
}

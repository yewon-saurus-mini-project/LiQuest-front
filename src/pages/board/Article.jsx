...
function Article({ initialArticleData = {} }) {
  ...
  useEffect(() => {
    axios
      .get(import.meta.env.VITE_API_URL + `/board/${postId}/`, {
        headers: {
  ...
  const onDeleteCommentHandler = async (postId, commentId) => {
    const url =
      import.meta.env.VITE_API_URL + `/board/${postId}/comments/${commentId}/`;
    try {
  ...
  return (
    <div data-color-mode="light" className="lg:px-40 lg:py-10 p-4 m-auto">
      <div>
        <div>
            ...
            <>
              ...
              <>
                <span
                  onClick={onOpen}
                  className="user"
                  style={{ color: "#6B7270", fontSize: "0.9em" }}
                >
                  삭제
                </span>
                <Modal
                ...
                <>
                  {editing[comment.comment_id] ? (
                    <>
                      ...
                      <span
                        className="user"
                        style={{ color: "#6B7270", paddingLeft: "10px" }}
                        onClick={() =>
                          onUpdateSubmitHandler(postId, comment.comment_id)
                        }
                      >
                        수정
                      </span>
                    ...
                    <span
                      ...
                      onClick={() => {
                        ...
                        setEditing({ ...editing, [comment.comment_id]: true });
                      }}
                    >
                      수정
                    </span>
                  ...
                  <span
                    onClick={() => openModal(comment.comment_id)}
                    className="user"
                    style={{
                      color: "#6B7270",
                      paddingRight: "10px",
                  ...
                  <Modal
                    isOpen={isModalOpen(comment.comment_id)}
                    onOpenChange={() => closeModal(comment.comment_id)}
                    backdrop="Transparent"
                  >
                    <ModalContent>
                      {(onClose) => (

...
const Info = () => {
  ...
  const handleMouseOutMainImg = () => {
    if (mainImgContainerRef.current)
      mainImgContainerRef.current.style =
    ...
    <div>
      <div className="section w-full min-h-[100vh] flex justify-center items-center lg:gap-32 pt-[63px] bg-[var(--color-primary-500)]">
        <div className="text-white lg:p-0 px-4 py-10">
          ...
          <div className="mt-10 lg:w-[600px] w-full text-justify">
            <div className="text-xl font-light">
              문해력이란{" "}
              <span className="font-semibold">'글을 읽을 수 있는 능력'</span>을
              말합니다. 어휘력이 풍부한 사람은 글을 막힘 없이 읽을 수 있지만,
              그렇지 않은 사람은 글을 읽고 이해하기에 어려움을 겪습니다.
            </div>
            <div className="text-xl font-light mt-4">
              어떤 어휘가 어떤 문장에서 어떻게 사용되는지, LiQuest와 함께 언어적
              경험을 쌓아봅시다.
            </div>
          </div>
          <button
            className="text-lg mt-10 py-4 bg-[var(--color-primary-700)] hover:bg-[var(--color-primary-900)] w-[200px] hover:w-full transition-all rounded-full"
            type="button"
            onClick={() => {
              nav("/login");
            }}
        ...
        <div
          ...
          onMouseMove={handleMouseMoveMainImg}
          onMouseOut={handleMouseOutMainImg}
          className="rounded-full transition-all"
        >
          <div
            className={`${styles["info-graphic"]} lg:w-[600px] lg:h-[600px] md:w-[400px] rounded-full hover:w-[620px] hover:h-[620px] transition-all`}
          />
      ...
      <div className="section w-full min-h-[100vh] flex flex-col lg:flex-row justify-center items-center lg:gap-32 bg-[var(--color-primary-400)] py-10">
        <div className="text-white lg:p-0 px-4">
          <div className={styles["introduce"]}>
            ...
            <div className="lg:text-5xl text-2xl lg:mt-8 lg:mb-0 mb-8">
              시작해 보세요.
            </div>
          </div>
        </div>

...
function Header({ isLogin, setIsLogin, username }) {
        ...
        <div className="lg:flex hidden">
          {isLogin ? (
            <div className="flex items-center gap-[2em]">
              <Link
                to="/we"
                className="text-[var(--color-primary-900)] hover:text-[var(--color-primary-600)]"
              >
                개발팀 소개
              </Link>
              <Link
                to="/notice"
                className="text-[var(--color-danger-500)] hover:text-[var(--color-primary-600)]"
              >
                공지사항
              </Link>
              <Link
              ...
              <Link
                to="/rank"
                className="flex hover:text-[var(--color-primary-600)]"
              >
                전체랭킹
              </Link>
              <Link
              ...
              <button
                className="flex hover:text-[var(--color-warning-600)]"
                onClick={onClickLogout}
              >
                <IoMdLogOut style={{ width: "20px", height: "auto" }} />
                <span>&nbsp;&nbsp;로그아웃</span>
              </button>
            </div>
          ) : (
